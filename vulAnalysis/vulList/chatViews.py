...
#    漏洞增长趋势图by类型--输入输出
class TotalByTimeRiseType1ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType1Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--用户权限
class TotalByTimeRiseType2ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType2Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--第三方组件
class TotalByTimeRiseType3ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType3Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--安全配置
class TotalByTimeRiseType4ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType4Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--文件上传下载
class TotalByTimeRiseType5ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType5Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--命令执行&代码执行
class TotalByTimeRiseType6ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType6Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--业务逻辑
class TotalByTimeRiseType7ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType7Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--弱口令
class TotalByTimeRiseType8ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType8Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞增长趋势图by类型--其他
class TotalByTimeRiseType9ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsRiseType9Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
class TotalByTimeFixChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixModel.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--有课
class TotalByTimeFixItem1ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem1Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--官网
class TotalByTimeFixItem2ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem2Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--企播
class TotalByTimeFixItem3ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem3Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--直播
class TotalByTimeFixItem4ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem4Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--目睹云
class TotalByTimeFixItem5ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem5Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--MDN
class TotalByTimeFixItem6ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem6Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--MDC
class TotalByTimeFixItem7ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem7Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#    漏洞修复趋势图by项目--互联网
class TotalByTimeFixItem8ChartsView(View):
    def get(self,request):
        try:
            vuls = models.Total_vulsFixItem8Model.objects.all()
        except vuls.DoesNotExist:
            return JsonResponse({
                "success":"404",
                "data":"未查询到内容",
...
#  添加目睹漏洞修复趋势图数据接口by项目--有课
class TotalVulsFixItem1View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem1Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
...
#  添加目睹漏洞修复趋势图数据接口by项目--官网
class TotalVulsFixItem2View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem2Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
...
#  添加目睹漏洞修复趋势图数据接口by项目--企播
class TotalVulsFixItem3View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem3Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
...
#  添加目睹漏洞修复趋势图数据接口by项目--直播
class TotalVulsFixItem4View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem4Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
...
#  添加目睹漏洞修复趋势图数据接口by项目--目睹云
class TotalVulsFixItem5View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem5Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
...
#  添加目睹漏洞修复趋势图数据接口by项目--MDN
class TotalVulsFixItem6View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem6Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
...
#  添加目睹漏洞修复趋势图数据接口by项目--MDC
class TotalVulsFixItem7View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem7Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
...
#  添加目睹漏洞修复趋势图数据接口by项目--互联网
class TotalVulsFixItem8View(View):
    def post(self,request):
        data_bytes = request.body
        data_str = data_bytes.decode()
        data_dict = json.loads(data_str)
        ...
        try:
            data = models.Total_vulsFixItem8Model(
                data_id = data_dict['data_id'],
                fixed_amount = data_dict['fixed_amount'],
                fixing_amount = data_dict['fixing_amount'],
            )
